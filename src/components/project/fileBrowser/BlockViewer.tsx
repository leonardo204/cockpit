...
import { useChatContextOptional } from '@/components/project/ChatContext';
...
import type {
  ...
  SearchHit,
  SearchResponse,
} from '@/lib/codeMap/projectGraph/types';
import {
...
import { FloatingToolbar } from '@/components/project/FloatingToolbar';
import { AddCommentInput, SendToAIInput } from '@/components/project/CodeInputCards';
import { ViewCommentCard } from '@/components/project/ViewCommentCard';
...
export function BlockViewer({
  ...
  const handleSendToAISubmit = useCallback(
    async (question: string) => {
      if (!sendToAIInput || !chatContext || !cwd || !focalFile) return;
      try {
    ...
    [sendToAIInput, chatContext, cwd, focalFile, refreshComments],
  );
